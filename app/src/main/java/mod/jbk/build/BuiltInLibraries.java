...
public class BuiltInLibraries {
    ...
    public static String ANDROIDX_LIFECYCLE_COMMON = "lifecycle-common-jvm-2.9.4";
    ...
    public static String ANDROIDX_LIFECYCLE_RUNTIME = "lifecycle-runtime-android-2.9.4";
    public static String ANDROIDX_LIFECYCLE_RUNTIME_KTX_ANDROID = "lifecycle-runtime-ktx-android-2.9.4";
    public static String ANDROIDX_LIFECYCLE_SERVICE = "lifecycle-service-2.9.4";
    public static String ANDROIDX_LIFECYCLE_VIEWMODEL = "lifecycle-viewmodel-android-2.9.4";
    public static String ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE = "lifecycle-viewmodel-savedstate-android-2.9.4";
    ...
    public static String ANDROIDX_SAVEDSTATE = "savedstate-android-1.3.1";
    ...
    public static final BuiltInLibrary[] KNOWN_BUILT_IN_LIBRARIES = {
            new BuiltInLibrary(ANDROIDX_ACTIVITY, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_CORE_KTX, ANDROIDX_CORE_VIEWTREE,
                    ...
                    ANDROIDX_NAVIGATIONEVENT_ANDROID, ANDROIDX_SAVEDSTATE, ANDROIDX_TRACING, JETBRAINS_KOTLIN_STDLIB,
            ...
            new BuiltInLibrary(ANDROIDX_BROWSER, List.of(ANDROIDX_ANNOTATION_EXPERIMENTAL, ANDROIDX_ANNOTATION_JVM,
                    ANDROIDX_COLLECTION_JVM, ANDROIDX_CONCURRENT_FUTURES, ANDROIDX_CORE, ANDROIDX_INTERPOLATOR), "androidx.browser"),
            ...
            new BuiltInLibrary(ANDROIDX_DATASTORE_CORE_ANDROID, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_DATASTORE_ANDROID,
                    ANDROIDX_DATASTORE_CORE_OKIO_JVM, ANDROIDX_DATASTORE_PREFERENCES_ANDROID,
                    ANDROIDX_DATASTORE_PREFERENCES_CORE_ANDROID, ANDROIDX_DATASTORE_PREFERENCES_EXTERNAL_PROTOBUF,
                    ANDROIDX_DATASTORE_PREFERENCES_PROTO, JETBRAINS_KOTLIN_PARCELIZE_RUNTIME, JETBRAINS_KOTLIN_STDLIB,
                    JETBRAINS_KOTLINX_COROUTINES_CORE_JVM)),
            ...
            new BuiltInLibrary(ANDROIDX_DATASTORE_CORE_OKIO_JVM, List.of(ANDROIDX_DATASTORE_ANDROID,
                    ...
                    ANDROIDX_DATASTORE_PREFERENCES_CORE_ANDROID, ANDROIDX_DATASTORE_PREFERENCES_EXTERNAL_PROTOBUF,
                    ANDROIDX_DATASTORE_PREFERENCES_PROTO, OKIO_JVM, JETBRAINS_KOTLIN_STDLIB,
                    JETBRAINS_KOTLINX_COROUTINES_CORE_JVM)),
            ...
            new BuiltInLibrary(ANDROIDX_DATASTORE_PREFERENCES_ANDROID, List.of(ANDROIDX_DATASTORE_ANDROID,
                    ...
                    ANDROIDX_DATASTORE_PREFERENCES_CORE_ANDROID, ANDROIDX_DATASTORE_PREFERENCES_EXTERNAL_PROTOBUF,
                    ANDROIDX_DATASTORE_PREFERENCES_PROTO, JETBRAINS_KOTLIN_STDLIB, JETBRAINS_KOTLINX_COROUTINES_CORE_JVM)),

            new BuiltInLibrary(ANDROIDX_DATASTORE_PREFERENCES_CORE_ANDROID, List.of(ANDROIDX_DATASTORE_ANDROID,
                    ANDROIDX_DATASTORE_CORE_ANDROID, ANDROIDX_DATASTORE_CORE_OKIO_JVM,
                    ANDROIDX_DATASTORE_PREFERENCES_ANDROID, ANDROIDX_DATASTORE_PREFERENCES_EXTERNAL_PROTOBUF,
                    ANDROIDX_DATASTORE_PREFERENCES_PROTO, OKIO_JVM, JETBRAINS_KOTLIN_STDLIB)),
            ...
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_COMMON, List.of(ANDROIDX_ANNOTATION_JVM,
                    ANDROIDX_LIFECYCLE_LIVEDATA_CORE, ANDROIDX_LIFECYCLE_LIVEDATA,
                    ANDROIDX_LIFECYCLE_PROCESS, ANDROIDX_LIFECYCLE_RUNTIME,
                    ANDROIDX_LIFECYCLE_RUNTIME_KTX_ANDROID, ANDROIDX_LIFECYCLE_SERVICE,
            ...
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_LIVEDATA_CORE, List.of(ANDROIDX_CORE_COMMON, ANDROIDX_CORE_RUNTIME,
                    ANDROIDX_LIFECYCLE_COMMON, ANDROIDX_LIFECYCLE_LIVEDATA,
                    ANDROIDX_LIFECYCLE_PROCESS, ANDROIDX_LIFECYCLE_RUNTIME,
                    ANDROIDX_LIFECYCLE_RUNTIME_KTX_ANDROID, ANDROIDX_LIFECYCLE_SERVICE,
                    ANDROIDX_LIFECYCLE_VIEWMODEL,
                    ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE,
            ...
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_RUNTIME, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_CORE_COMMON, ANDROIDX_CORE_RUNTIME,
                    ANDROIDX_CORE_VIEWTREE, ANDROIDX_LIFECYCLE_COMMON,
                    ANDROIDX_LIFECYCLE_LIVEDATA_CORE, ANDROIDX_LIFECYCLE_LIVEDATA,
                    ANDROIDX_LIFECYCLE_PROCESS, ANDROIDX_LIFECYCLE_RUNTIME_KTX_ANDROID,
                    ANDROIDX_LIFECYCLE_SERVICE, ANDROIDX_LIFECYCLE_VIEWMODEL,
                    ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE,
                    JETBRAINS_KOTLIN_STDLIB, JETBRAINS_KOTLINX_COROUTINES_ANDROID,
                    JSPECIFY)),

            new BuiltInLibrary(ANDROIDX_LIFECYCLE_RUNTIME_KTX_ANDROID, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_LIFECYCLE_COMMON,
                    ANDROIDX_LIFECYCLE_LIVEDATA_CORE, ANDROIDX_LIFECYCLE_LIVEDATA,
                    ANDROIDX_LIFECYCLE_PROCESS, ANDROIDX_LIFECYCLE_RUNTIME,
                    ANDROIDX_LIFECYCLE_SERVICE, ANDROIDX_LIFECYCLE_VIEWMODEL,
                    ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE,
            ...
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_SERVICE, List.of(ANDROIDX_LIFECYCLE_COMMON,
                    ANDROIDX_LIFECYCLE_LIVEDATA_CORE, ANDROIDX_LIFECYCLE_LIVEDATA,
                    ANDROIDX_LIFECYCLE_PROCESS, ANDROIDX_LIFECYCLE_RUNTIME,
                    ANDROIDX_LIFECYCLE_RUNTIME_KTX_ANDROID,
                    ANDROIDX_LIFECYCLE_VIEWMODEL,
                    ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE,
                    JETBRAINS_KOTLIN_STDLIB)),

            new BuiltInLibrary(ANDROIDX_LIFECYCLE_VIEWMODEL, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_CORE_VIEWTREE, ANDROIDX_LIFECYCLE_COMMON,
                    ANDROIDX_LIFECYCLE_LIVEDATA_CORE, ANDROIDX_LIFECYCLE_LIVEDATA,
                    ANDROIDX_LIFECYCLE_PROCESS, ANDROIDX_LIFECYCLE_RUNTIME,
                    ANDROIDX_LIFECYCLE_RUNTIME_KTX_ANDROID, ANDROIDX_LIFECYCLE_SERVICE,
                    ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE,
            ...
            new BuiltInLibrary(ANDROIDX_LIFECYCLE_VIEWMODEL_SAVEDSTATE, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_CORE_KTX, ANDROIDX_LIFECYCLE_COMMON,
                    ...
                    ANDROIDX_LIFECYCLE_PROCESS, ANDROIDX_LIFECYCLE_RUNTIME,
                    ANDROIDX_LIFECYCLE_RUNTIME_KTX_ANDROID, ANDROIDX_LIFECYCLE_SERVICE,
                    ANDROIDX_LIFECYCLE_VIEWMODEL, ANDROIDX_SAVEDSTATE,
                    JETBRAINS_KOTLIN_STDLIB, JETBRAINS_KOTLINX_COROUTINES_ANDROID,
                    JETBRAINS_KOTLINX_COROUTINES_CORE_JVM,
                    JETBRAINS_KOTLINX_SERIALIZATION_CORE_JVM)),

            new BuiltInLibrary(ANDROIDX_LOADER, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_COLLECTION_JVM, ANDROIDX_CORE,
            ...
            new BuiltInLibrary(ANDROIDX_NAVIGATIONEVENT_ANDROID, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_RUNTIME_ANNOTATION_ANDROID,
                    ANDROIDX_CORE_VIEWTREE, JETBRAINS_KOTLIN_STDLIB,
                    JETBRAINS_KOTLINX_COROUTINES_ANDROID,
                    JETBRAINS_KOTLINX_COROUTINES_CORE_JVM), "androidx.navigationevent"),
            ...
            new BuiltInLibrary(ANDROIDX_SAVEDSTATE, List.of(ANDROIDX_ANNOTATION_JVM, ANDROIDX_CORE_KTX, ANDROIDX_CORE_VIEWTREE,
                    ANDROIDX_LIFECYCLE_COMMON, JETBRAINS_KOTLIN_STDLIB,
                    JETBRAINS_KOTLINX_COROUTINES_CORE_JVM,
                    JETBRAINS_KOTLINX_SERIALIZATION_CORE_JVM)),
            ...
            new BuiltInLibrary(ANDROID_YOUTUBE_PLAYER, List.of(ANDROIDX_LIFECYCLE_RUNTIME_KTX_ANDROID, JETBRAINS_KOTLIN_STDLIB), "com.pierfrancescosoffritti.androidyoutubeplayer"),
            ...
            new BuiltInLibrary(PLAY_SERVICES_ADS_API, List.of(ANDROIDX_BROWSER, ANDROIDX_CORE, ANDROIDX_DATASTORE_ANDROID,
                    ...
                    JETBRAINS_KOTLIN_STDLIB, JETBRAINS_KOTLINX_COROUTINES_ANDROID,
                    JETBRAINS_KOTLINX_COROUTINES_CORE_JVM), "com.google.android.gms.ads"),
            ...
            new BuiltInLibrary(PLAY_SERVICES_AUTH, List.of(ANDROIDX_FRAGMENT, ANDROIDX_LOADER, PLAY_SERVICES_AUTH_API_PHONE,
                    ...
                    PLAY_SERVICES_FIDO, PLAY_SERVICES_TASKS), "com.google.android.gms.auth.api"),
